...
type KPIDetailsSprintBurndownDetailsProps = {
  KPI: LoadObject<KPI>
};

type KPIDetailsSprintBurndownDetailsState = {
};

class KPIDetailsSprintBurndownDetails extends React.Component<KPIDetailsSprintBurndownDetailsProps, KPIDetailsSprintBurndownDetailsState> {
   render() {
...
export default KPIDetailsSprintBurndownDetails;